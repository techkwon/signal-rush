export const stageDifficulties = [
  { label: "입문", collisionDamage: 8, hazardRows: 2, spawnInterval: 2.4, speedBonus: 0, repairAmount: 4 },
  { label: "초급", collisionDamage: 10, hazardRows: 3, spawnInterval: 2.15, speedBonus: 1.2, repairAmount: 4 },
  { label: "중급", collisionDamage: 13, hazardRows: 3, spawnInterval: 1.9, speedBonus: 2.6, repairAmount: 5 },
  { label: "고급", collisionDamage: 16, hazardRows: 4, spawnInterval: 1.68, speedBonus: 4.2, repairAmount: 6 },
  { label: "도전", collisionDamage: 17, hazardRows: 4, spawnInterval: 1.62, speedBonus: 5, repairAmount: 9 },
  { label: "최종", collisionDamage: 19, hazardRows: 5, spawnInterval: 1.5, speedBonus: 6, repairAmount: 12 },
];
